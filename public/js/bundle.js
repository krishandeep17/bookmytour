...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoia3Jpc2hhbmRlZXAiLCJhIjoiY2xjaGI4bGQ0MGJ6ZzN4czVldzByZDdqNiJ9.gqI-4gydqCwNROcvoQp9mw";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/krishandeep/clchbicft004014mry6lsk677",
    scrollZoom: false
  });
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe("pk_test_51MQNicSE7V3Zi74rJjglWPjUJYEBOn0WZhaBGnaS4LPSHL8xT9InAHz5IBLzmEo0GboPPL7u9Vyo7JbscRp2D3P20001YY9sxu");
          _context.prev = 1;
          _context.next = 4;
...
if (userDataPassword) {
  userDataPassword.addEventListener("submit", function (e) {
    e.preventDefault();
